                ...
                <div className="px-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between space-x-4">
                        ...
                        <button
                            ...
                            className="flex items-center px-4 py-2 border-2 font-semibold text-white transition rounded-full shadow-lg bg-[#1d4dd5] hover:scale-105 focus:outline-none focus:ring-2 focus:ring-pink-400"
                        >
